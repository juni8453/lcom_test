...
//
//import com.lcom_test.example.domain.Kakaopay;
...
//    private String tid;
//
//    public Kakaopay ready(String agent, String openType) {
...
//        ResponseEntity<Kakaopay> response = new RestTemplate().postForEntity("https://kapi.kakao.com/v1/payment/ready", entityMap, Kakaopay.class);
//        Kakaopay readyResponse = response.getBody();
//
